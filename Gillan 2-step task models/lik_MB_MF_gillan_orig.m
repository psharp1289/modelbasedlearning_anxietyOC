function lik = lik_MB_MF_gillan_orig(P,data) 
...
%         Qm_state1=maxQ;
        ...
        if s==2
            ...
            Qd2(:,unchosentwo)=Qd2(:,unchosentwo).*(1-lr1);
            Qd3(:,1)=Qd3(:,1).*(1-lr1);
            Qd3(:,2)=Qd3(:,2).*(1-lr1);
        elseif s==3
            ...
            Qd3(:,unchosentwo)=Qd3(:,unchosentwo).*(1-lr1);
            Qd2(:,1)=Qd2(:,1).*(1-lr1);
            Qd2(:,2)=Qd2(:,2).*(1-lr1);
        end
        %decay unchosen actions
        Qd1(:,unchosen)=Qd1(:,unchosen).*(1-lr1);
        Qd1a(:,unchosen)=Qd1a(:,unchosen).*(1-lr1);
